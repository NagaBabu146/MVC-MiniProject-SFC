...
public class PatientDAOImpl implements PatientDAO {
	...
	private static final String GET_PATIENTDETAILS_BY_ID = "SELECT PATIENTID,PATIENTNAME,AGE,ADRESS,PROBLEM,WARDNO,DOCTOR,CONTACT FROM PATIENTINFO WHERE PATIENTID=?";
	private static final String UPDATE_PATIENT_BY_ID = "UPDATE PATIENT_INFO SET PATIENTNAME=?,AGE=?,ADRESS=?,PROBLEM=?,WARDNO=?,DOCTOR=?,CONTACT=? WHERE PATIENTID=?";
